...
// Railway_Control Base Station COMMUNICATES VIA THE SERIAL PORT USING SINGLE-CHARACTER TEXT COMMANDS
  ...
  switch (com[0]) {
    ...
    case 'B':      // <B CV BIT VALUE CALLBACKNUM CALLBACKSUB>
      /*
            ...
            CALLBACKSUB: a second arbitrary integer (0-32767) that is ignored by the Base Station and is simply echoed back in the output - useful for external programs (e.g. Railway_Control Interface) that call this function
    ...
    case 'c':     // <c>
      ...
      */
      ...
      INTERFACE.print(" >");
      //  With canton management
      I2C_Command::I2C_Current_sensor;
      break;
    ...
    /***** READ STATUS OF Railway_Control Base Station  ****/
    ...
    case 's':      // <s>
      /*
           ...
           returns: series of status messages that can be read by an interface to determine status of Railway_Control Base Station and important settings
      */
      ...
      INTERFACE.print(" < iRailway_Control Base Station ");
    ...
    case 't':       // <t REGISTER CAB SPEED DIRECTION CANTON>
      ...
      */
      I2C_Command::I2C_Throttle(com + 1);
