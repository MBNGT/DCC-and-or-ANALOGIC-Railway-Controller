...
/**********************************************************************
  ...
  Railway_Control Base Station supports Sensor inputs that can be connected to any Aruidno Pin
...
void Sensor::check() {
  Sensor *tt;
  //  At first resquest for current measures from Nano
  //I2C_Command::I2C_Current_sensor();

  //  and other infrared sensors
