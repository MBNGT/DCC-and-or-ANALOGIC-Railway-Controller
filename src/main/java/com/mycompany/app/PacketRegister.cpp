...
void RegisterList::setThrottle(char *s) volatile {
  ...
  ///////////////////////////////////////////////////////////////////////////////
  //    WARNING
  //    In case of Cantons management (See I2C_Throttle) these print send erratic speed value to Processing
  //      so, these erratic values modify the cab's Processing required speed
  ///////////////////////////////////////////////////////////////////////////////
  //INTERFACE.print("<T");
